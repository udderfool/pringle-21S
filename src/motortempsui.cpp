...
void tempcheckctrl() {
  while(true) {
    ...
    if(master.get_digital(pros::E_CONTROLLER_DIGITAL_Y) == true) {
        if(intakeTemp <= 30) pros::c::controller_print(pros::E_CONTROLLER_MASTER, 0, 0, "i: cool, %.0f°C    ", intakeTemp);
        else if(intakeTemp > 30 && intakeTemp <= 45) pros::c::controller_print(pros::E_CONTROLLER_MASTER, 0, 0, "i: warm, %.0f°C    ", intakeTemp);
        else if(intakeTemp > 45) pros::c::controller_print(pros::E_CONTROLLER_MASTER, 0, 0, "i: hot, %.0f°C    ", intakeTemp);
        pros::delay(2000);
    } else if(master.get_digital(pros::E_CONTROLLER_DIGITAL_RIGHT) == true) {
        if(wallmechTemp <= 30) pros::c::controller_print(pros::E_CONTROLLER_MASTER, 0, 0, "w: cool, %.0f°C    ", wallmechTemp);
        else if(wallmechTemp > 30 && wallmechTemp <= 45) pros::c::controller_print(pros::E_CONTROLLER_MASTER, 0, 0, "w: warm, %.0f°C    ", wallmechTemp);
        else if(wallmechTemp > 45) pros::c::controller_print(pros::E_CONTROLLER_MASTER, 0, 0, "w: hot, %.0f°C    ", wallmechTemp);
        pros::delay(2000);
    } else {
        if(driveTemp <= 30) pros::c::controller_print(pros::E_CONTROLLER_MASTER, 0, 0, "d: cool, %.0f°C    ", driveTemp);
        else if(driveTemp > 30 && driveTemp <= 45) pros::c::controller_print(pros::E_CONTROLLER_MASTER, 0, 0, "d: warm, %.0f°C    ", driveTemp);
        else if(driveTemp > 45) pros::c::controller_print(pros::E_CONTROLLER_MASTER, 0, 0, "d: hot, %.0f°C    ", driveTemp);
        pros::delay(2000);
    }
    pros::delay(10);
  }
