...
void initialize() {
  ...
  chassis.opcontrol_curve_default_set(5, 0);     // Defaults for curve. If using tank, only the first parameter is used. (Comment this line out if you have an SD card!)
  ...
  ez::as::auton_selector.autons_add({
      ...
      Auton("full mogos and alliance", skills)
